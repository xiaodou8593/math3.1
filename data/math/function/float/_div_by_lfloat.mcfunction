...
scoreboard players operation sstempd int = lfloat_int0 int
scoreboard players operation sstempd int *= 10000 int
scoreboard players operation sstempd int += lfloat_int1 int
...
#符号位
scoreboard players operation float_sign int *= lfloat_sign int
#指数
scoreboard players operation float_exp int -= lfloat_exp int
#0的指数校准
