...
execute store result score stemp0 int run scoreboard players operation res int /= 2 int
scoreboard players operation stemp0 int *= stemp0 int
execute if score stemp0 int > inp int run scoreboard players remove res int 1